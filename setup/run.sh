...
PROG_ROOTDIR=/media/nander/46d45ce3-2115-47b4-90e0-f01b0b010844/src/polarsnowpack_master/usr/bin/	#if you do not want to use Alpine3D from PATH, then point to where it is
PROG_ROOTDIR=/projects/nawe3645/src/polarsnowpack_core/usr/bin/
